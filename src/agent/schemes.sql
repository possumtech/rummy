-- PREP: upsert_scheme
INSERT INTO schemes (name, model_visible, category, default_scope, writable_by, volatile)
VALUES (
	:name
	, :model_visible
	, :category
...
SELECT name, model_visible, category, default_scope, writable_by, volatile FROM schemes;
