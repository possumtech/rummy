...
describe("LlmProvider", () => {
	it("should route completion requests to OllamaClient when model starts with ollama/", async () => {
		const completionMock = mock.method(OllamaClient.prototype, "completion", async (messages, model) => {
	...
	it("should route completion requests to OpenRouterClient by default", async () => {
		const completionMock = mock.method(OpenRouterClient.prototype, "completion", async (messages, model) => {
